...
class NextcloudUser(HttpUser):
    ...
    def upload_file_1kb(self):
        remote_path = f"/remote.php/dav/files/{self.user_name}/1kb_file"
        with open("/Users/emanuele/desktop/cloud/testdata/file1KB", "rb") as file:
            self.client.put(remote_path, data=file, auth=self.auth, name="/remote.php/dav/files/[user]/1kb_file")
        self.client.delete(remote_path, auth=self.auth, name="/remote.php/dav/files/[user]/1kb_file")
